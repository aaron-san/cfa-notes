---
title: "CFA&reg; Level 1: Quantitative Methods (part 2)"
...
thumbnail: ""
backUrl: "blog/cfa-level-1/quantative-methods-1"
nextUrl: "blog/cfa-level-1/quantative-methods-3"
---
...
<Math>{"SF = \\frac{E(R_{p}) - R_{L}} {sigma _{p}}"}</Math>
...
<Math>{"\\frac{S_{t+1}} {S_{t}} = 1 + R_{t, t+1}"}</Math>

## Continuously Compounded Return

<Math>{"r_{t, t+1} = ln(\frac{S_{t+1}} {S_{t}}) = ln(1 + R_{t, t+1})"}</Math>
...
<Math>{"\\mathrm {\\small Value_{T} = Max(0, S_{T} - \\bar{S})}"}</Math>
