---
title: "CFA&reg; Level 1: Alternative Investments (Part 1)"
date: "2022-11-28"
description: "Alternative investments is a growing field full of potential profit opportunities. Learn about the basics here."
categories: "CFA&reg; Level 1"
tags: ["Alternative Investments"]
slug: "alternative-investments-1"
backUrl: "/topics/cfa-level-1"
nextUrl: "blog/cfa-level-1/alternative-investments-2"
---
...
- Quoted using add-on interest:

<Math>{`\\mathrm {FV = PV \\cdot (1 + i)^n}`}</Math>
...
<Note>
  Markets in which the predominant traders are commodity producers, hedging
  against declines in the price of the commodity by selling futures (short
  hedgers), tend to be in backwardation, with futures prices less than spot
  prices. Roll yield is positive when a futures market is in backwardation.
</Note>
