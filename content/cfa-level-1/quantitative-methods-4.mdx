---
title: "CFA&reg; Level 1: Quantitative Methods (Part 4)"
...
- Assumptions:
  ...
  1. Value is determined by supply and demand
  2. Supply and demand is driven by both rational and irrational behavior \* Prices move in trends that persist for long periods
...
6. Stock index futures - observe expected price growth
...
- Fundamentalists believe they can forecast value changes by analyzing earnings and other publicly available data.
