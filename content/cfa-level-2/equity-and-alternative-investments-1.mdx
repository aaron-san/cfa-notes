...
1. [Free Cash Flow Valuation](#capital-budgeting)
2. [Market Based Valuation - Price and Enterprise Value Multiples](./corporate-finance-3#capital-structure)
3. [Residual Income Valuation](./corporate-finance-4#dividends-and-share-repurchases)
4. [Private Company Valuation](./corporate-finance-5#corporate-governance)

<a id="capital-budgeting" />

## Alpha
- Alpha = expected return - required return (e.g., CAPM or APT)

## Franchsee Value
- The value of a firm with a strong brand name that allows it to earn economic profits in excess of the required return on equity
- Tangible P/E = 1/r
- Franchise P/E = Franchise Factor (FF) * Growth Factor (GF)
- If ROE > r, the firm has a sustainable competitive advantage, FF > zero
- If FF > 0, a higher retention ratio means higher GF and higher franchise P/E
