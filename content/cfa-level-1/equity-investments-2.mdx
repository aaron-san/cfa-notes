...
- Borrowing costs
- Negative information is less likely divulged by insiders
- Sell-side analysts predominantly issue "puy" recommendations
...
- Long-short portfolios permit the manager to use borrowed (short) funds to buy more long positions (weights can exceed 100%)
