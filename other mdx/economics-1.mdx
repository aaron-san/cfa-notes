...
```math
\small {E_{i} = \frac{\Delta \text{Quantity Demanded}} { \Delta Income}}
```
...
```math
\small {E_{p} = \frac{\Delta Quantity Supplied} {\Delta Price} = \frac{\Delta Q_{s} \div Q_{ave}} {\Delta P \div {P_{ave}}}}
```
