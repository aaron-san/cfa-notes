...
nextUrl: "blog/cfa-level-2/alternative-investments-2"
---
...
<Math>{"\\mathrm {\\small {Cap rate = r_{NOI} - g_{NOI}}}"}</Math>
...
<Math>{"\\mathrm {ERAT = Net selling price - Mortgage balance - Taxes}"}</Math>
