...
thumbnail: ""
backUrl: "quantitative-methods-part-2"
nextUrl: "quantitative-methods-part-4"
---
...
```math
\mathrm {\small {P(A \cup B) = P(A) + P(B) - P(A \cap B)}}
```

## Multiplication Rule of Probability

```math
\mathrm {\small {P(A \cap B) = P(A) \cdot P(B)}}
```
...
```math
\mathrm {\small {1-P(Type II Error)}}
```
