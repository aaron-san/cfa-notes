...
<Math>{"\\mathrm {small {SF = \frac{E(R_{p}) - R_{L}} {sigma _{p}}}}"}</Math>
...
<Math>{"\\mathrm {small \frac{S_{t+1}} {S_{t}} = 1 + R_{t, t+1}}"}</Math>

## Continuously Compounded Return

<Math>
  {
    "\\mathrm {small r_{t, t+1} = ln(\frac{S_{t+1}} {S_{t}}) = ln(1 + R_{t, t+1})}"
  }
</Math>
